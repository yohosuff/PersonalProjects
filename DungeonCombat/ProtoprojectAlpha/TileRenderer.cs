...
namespace DungeonCombat
{
    class TileRenderer
    {
        ...
        static public void Initialize()
        {
            ...
            LoadTileTexture(@"Tiles/goblin.png", "goblin");
            LoadTileTexture(@"Tiles/green.png", "green");
            LoadTileTexture(@"Tiles/ninja.png", "ninja");
            LoadTileTexture(@"Tiles/pillar.png", "pillar");
            LoadTileTexture(@"Tiles/red.png", "red");
            LoadTileTexture(@"Tiles/rogue.png", "rogue");
            LoadTileTexture(@"Tiles/skull.png", "skull");
            LoadTileTexture(@"Tiles/warrior.png", "warrior");
            
            //LoadTileTexture(Properties.Resources.floorTile, "floor");
            //LoadTileTexture(Properties.Resources.pillar, "pillar");
            //LoadTileTexture(Properties.Resources.dirt, "dirt");
            //LoadTileTexture(Properties.Resources.ninja, "ninja");
            //LoadTileTexture(Properties.Resources.beserker, "beserker");
            //LoadTileTexture(Properties.Resources.warrior, "warrior");
            //LoadTileTexture(Properties.Resources.cursor, "cursor");
            //LoadTileTexture(Properties.Resources.bricks, "bricks");
            //LoadTileTexture(Properties.Resources.elf, "elf");
            //LoadTileTexture(Properties.Resources.skull, "skull");
            //LoadTileTexture(Properties.Resources.green, "green");
            //LoadTileTexture(Properties.Resources.red, "red");
        ...
        static public void LoadTileTexture(Bitmap bitmap, string tileName)
        {
            TextureInfo textureInfo = new TextureInfo(bitmap, tileName);
            textureInfo.id = LoadTexture(bitmap);
            textures.Add(textureInfo);
        }
        ...
        static private int LoadTexture(Bitmap bitmap)
        {
            int id = GL.GenTexture();
